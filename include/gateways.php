...
<?php
	...
	foreach ($gateways as $gateway) {
		...
		echo "<tr>";
		echo "<td class=\"riga\">".convertTimezone($gateway['timestamp'])."</td>";
		
		if (constant("GDPR"))
			echo"<td nowrap class=\"riga\">".str_replace("0","&Oslash;",substr($gateway['callsign'],0,3)."***")."</td>";
		else
			echo"<td nowrap class=\"riga\">".str_replace("0","&Oslash;",$gateway['callsign'])."</td>";
		echo "</tr>";
	}
?>
  </tbody>
