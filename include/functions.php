...
// ********************************************************
// ********************************************************
function getYSFReflectorLogIZ6RND($mode=null) {
	if ( $mode == "demo" ) {
		$logPath  = "/var/log/YSFReflector/log-test.log";
	} else {
	...
	*/
	foreach($logLines as $line) {
		...
		}/* elseif ( strpos($line, 'end of transmission') == true ) {
			array_push($logLines, "");
		} else {
			array_push($logLines, "");
		}*/
...
function getLastHeardIZ6RND($logLines) {
	/*
